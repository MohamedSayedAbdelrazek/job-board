<section class="space-y-6">
    ...
    <x-modal name="confirm-user-deletion" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 bg-gray-900 border border-gray-800 rounded-lg">
            @csrf
            @method('delete')
            ...
            <div class="mt-6 flex justify-end space-x-3">
                <x-secondary-button x-on:click="$dispatch('close')" class="bg-gray-800 hover:bg-gray-700 focus:ring-gray-500">
                    {{ __('Cancel') }}
                </x-secondary-button>
