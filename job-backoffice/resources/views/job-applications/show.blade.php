                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-800">
                        @if($jobApplication->jobVacancy->title)
                            <a target="_blank" href="{{ route('job-vacancies.show', $jobApplication->jobVacancy->id) }}"
                ...
                <div>
                    ...
                    <p class="mt-1">
                        @if ($jobApplication->resume->fileUri)
                            <a target="_blank"
                                href="https://fls-9f561587-3613-46ec-a152-90060a350e9a.laravel.cloud/{{ $jobApplication->resume->fileUri }}"
                ...
                <div>
                    ...
                    <p class="mt-1">
                        @if ($jobApplication->jobVacancy->company->name)
                            <a target="_blank" href="{{ route('companies.show', $jobApplication->jobVacancy->company->id)}}"
                                class="text-blue-600 hover:underline">
